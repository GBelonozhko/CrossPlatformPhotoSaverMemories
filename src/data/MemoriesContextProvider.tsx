...
const MemoriesContextProvider: React.FC =(props)=>{
 ...
 const addMemory =(imagePath: string, base64Data:string, title:string, type:'good'|'bad' ) => {
 ...
 const initContext = useCallback (async () => {
    ...
    return(
        <MemoriesContext.Provider value={{memories, addMemory, initContext}}>{props.children}</MemoriesContext.Provider>
    )
};
